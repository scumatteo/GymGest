  ...
  handleSubmit = (event) => {
    ...
    if (this.checkProperties()) {
      ...
      Axios.post("http://localhost:3001/api/auth/signup", user)
        .then((res) => {
          if (res.status === 201) {
            this.setDialogProperties(dialog)(true)(false)(res.data.message);
          }
        ...
        .catch((err) => {
          if (err.response) {
            ...
            this.setDialogClosing(dialog)(null);
          }
        });
    }
  };
    ...
    return (
      <Container maxWidth="xs">
        ...
        <div className={this.classes.paper}>
          ...
          <Link href="/signin" variant="body2" className={this.classes.link}>
...
export default withStyles(styles)(withRouter(UserSignUp));
